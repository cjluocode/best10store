"""
Django settings for Best10 project.
...
ALLOWED_HOSTS = ['www.best10.store', 'best-10.herokuapp.com','best10.store']
...
WSGI_APPLICATION = 'Best10.wsgi.application'
