...
XPATH_IMAGE = ".//img[@class='s-access-image cfMarker']/@src"
...
XPATH_RATING_COUNT_4 = ".//div[@class='a-row a-spacing-none']/a[@class='a-size-small a-link-normal a-text-normal']"

XPATH_RATING = ".//span[@class='a-icon-alt']/text()"

XPATH_PRICE_1  = ".//span[@class='sx-price-whole']/text()"
XPATH_PRICE_2  = ".//span[@class='a-size-base a-color-base']/text()"